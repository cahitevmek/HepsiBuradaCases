...
public class HepsiBuradaCase2
{
    ...
    public void test() throws InterruptedException {
        ...
        //75 tl üstü ürün listelenmesi
        Thread.sleep(5000);
        clickByXpath("//div[@class='range-contain-row left']/input[@class='input free' and @placeholder = 'En az']");
        writeByXpath("//div[@class='range-contain-row left']/input[@class='input free' and @placeholder = 'En az']","75");
        ...
        productName = getTextFromAttributeByXpath("//button[@class='add-to-basket button small']","data-product",3,"productName\":\"", "\",\"categoryId");
        clickByXpath("//button[@class='add-to-basket button small']",3);
        Thread.sleep(5000);
        ...
        //Sepete eklenen ürünün kargo bedava olduğunun doğrulanması
        textControlByXpath("//div[@class='price']/strong[@data-bind='text: shippingPrice']","0,00");
